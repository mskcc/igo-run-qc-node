...
export const NANOPORE_HEADERS =['QC Status', 'IGO ID', 'QC Record Id', 'Reads','Bases','N50','Median Read Length','Flowcell','Position','Estimated Coverage', 'Sample', 'Recipe','Sum Mean Target Coverage'];
